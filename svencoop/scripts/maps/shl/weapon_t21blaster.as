...
const string T21_SOUND_DRAW		= "portalhouse/selectBowcaster.wav";
const string T21_SOUND_FIRE1		= "portalhouse/fireT21.wav";
const string T21_SOUND_DRYFIRE		= "portalhouse/dryfire.wav";

const string T21_MODEL_NULL		= "models/not_precached2.mdl";
const string T21_MODEL_VIEW		= "models/portalhouse/v_t21.mdl";
const string T21_MODEL_PLAYER		= "models/portalhouse/p_t21.mdl";
const string T21_MODEL_GROUND		= "models/portalhouse/w_t21.mdl";
const string T21_MODEL_CLIP		= "models/w_weaponbox.mdl";
const string T21_MODEL_PROJECTILE	= "models/portalhouse/HighPowerBlasterShootRed.mdl";
...
void RegisterT21Blaster()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_t21blaster", "portalhouse", "highpowerblaster" );
}
