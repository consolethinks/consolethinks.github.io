...
const int HREPEATER_DAMAGE				= 16;

const string HREPEATER_SOUND_DRAW		= "portalhouse/selectRifleBlaster.wav";
const string HREPEATER_SOUND_FIRE		= "portalhouse/fire_minigun01.wav";
const string HREPEATER_SOUND_EXPLODE		= "portalhouse/hit_wallHeavyRepeater.wav";
const string HREPEATER_SOUND_FIREALT		= "portalhouse/fire_minigun01.wav";
const string HREPEATER_SOUND_EXPLODEALT		= "portalhouse/alt_explodeHeavyRepeater.wav";
const string HREPEATER_SOUND_DRYFIRE		= "portalhouse/dryfire.wav";

const string HREPEATER_MODEL_NULL		= "models/not_precached2.mdl";
const string HREPEATER_MODEL_VIEW		= "models/portalhouse/v_768mmvulcan.mdl";
const string HREPEATER_MODEL_PLAYER		= "models/portalhouse/p_768mmvulcan.mdl";
const string HREPEATER_MODEL_GROUND		= "models/portalhouse/w_vulcan.mdl";
const string HREPEATER_MODEL_CLIP		= "models/portal_house/w_768ammo.mdl";
...
class weapon_vulcan : ScriptBasePlayerWeaponEntity
{
	...
	{
		m_pPlayer.m_flNextAttack = WeaponTimeBase() + 0.3;
...
void RegisterHREPEATER()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_vulcan", "portalhouse", "556" );
}
